										...
										<div class="row">
                                            ...
                                            <div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													...
													<input name="fname" type="text" class="form-control" id="to-place" />
												</div>
                                            </div>
                                            <div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">Last Name:</label>
													<input name="lsname" type="text" class="form-control" id="to-place" />
												</div>
                                            </div>
                                            <div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">Address:</label>
													<textarea name="address" type="text" class="form-control" id="to-place"></textarea>
												</div>
                                            </div>
                                            <div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">Phone:</label>
													<input name="phone" type="text" class="form-control" id="to-place" />
												</div>
                                            </div>
                                            <div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<label for="from">Gender:</label>
													<input name="gender" type="text" class="form-control" id="to-place" />
												</div>
											</div>
